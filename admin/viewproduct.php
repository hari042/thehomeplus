...
$q=mysqli_query($con,"SELECT * FROM `product`"); ?>
        ...
        <?php       while($r=mysqli_fetch_array($q)) {  ?>
                        <tr>
                           ...
                           <td><button class="btn btn-warning"><a href="editproduct.php?pdid=<?php echo $r['pid']; ?>" style="color:#fff;">Edit</a></button>|<button class="btn btn-danger"><a href="deleteprod.php?prodid=<?php echo $r['pid']; ?>" onclick=" return confirm('do you want to delete')" style="color:#fff;">Delete</a></button></td>
                        </tr>
