...
<?php
		...
		if (isset($_POST['ADD'])) 
        {
          ...
          $chk=mysqli_query($con,"SELECT * FROM `category` WHERE categoryname='$cname'");
            ...
            else
            {
				...
				$q=mysqli_query($con,"INSERT INTO `category`( `categoryname`, `image`) VALUES ('$cname','$img')");
		      if ($q)
               {
...
<form action="" method="post" enctype="multipart/form-data" autocomplete="off">
	...
	<input type="text" name="catname"  maxlength="32" onkeypress="return (event.charCode > 64 && event.charCode < 91) || (event.charCode > 96 && event.charCode < 123)" class="form-control" placeholder="Enter the category name" required pattern="[a-zA-Z\s]+">
	</div>
	<div class="form-group">
		<label for="pwd">Select Image:</label>
		<input type="file" class="form-control" name="catimage" required>
	</div>
