...
$q=mysqli_query($con,"SELECT * FROM `subcategory`"); ?>
        ...
        <?php       while($r=mysqli_fetch_array($q)) {  ?>
                        <tr>
                            ...
                            <td><button class="btn btn-warning"><a href="editsubcat.php?subcatid=<?php echo $r['subid']; ?>" style="color:#fff;">Edit</a></button>|<button class="btn btn-danger"><a href="deletesubcat.php?subcatid=<?php echo $r['subid']; ?>" onclick=" return confirm('do you want to delete')" style="color:#fff;">Delete</a></button></td>
                        </tr>
