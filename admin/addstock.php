...
<?php
		...
		$q=mysqli_query($con,"INSERT INTO `stock`( `categoryid`, `subid`, `pid` ,`qty`, `price`, `image`,`image1`,`image2`,`material`, `description`) VALUES ('$cd','$sd','$pd','$qty','$price','$img','$img1','$img2','$material','$description')");
		if ($q)
               {
                 echo "<script>swal('UPLOADED');</script>";
			     		      }
		      else
              {
...
<?php } ?>
	...
	<select name="sbctid" id="sbctid" class="form-control" required  onchange="showHint1(this.value)">
	...
	<select name="prodid" class="form-control" id="prodid" required >
...
<input type="number" name="qty"  class="form-control" placeholder="Enter the Product Quantity" required >
</div>
<div class="form-group">
...
<div class="form-group">
		<label for="uname">Product Material:</label>
<input type="text" name="material"  class="form-control" placeholder="Enter the Material type" >
</div>
<div class="form-group">
