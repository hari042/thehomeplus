...
if (isset($_POST['pincheck'])) {

	$q=mysqli_query($con,"SELECT * FROM `location` WHERE pincode='$_POST[pincode]'");
	if (mysqli_fetch_array($q)) {
		echo "<script>swal('servise available for this location');
			window.location='product.php?sid=$sid';</script>";
	}
	else {
		echo "<script>swal('servise not available for this location');
			window.location='product.php?sid=$sid';</script>";
	}
}
...
.page-head_agile_info_w3l {
    background: url("imgc/bg7.jpg") no-repeat center;
	...
	<div class="header-bot_inner_wthreeinfo_header_mid">
		...
		<!-- header-bot -->
			<div class="col-md-4 logo_agile">
				<h1><a>HomePlus<i class="fa fa-shopping-bag top_logo_agile_bag" aria-hidden="true"></i></a></h1>
			</div>
        <!-- header-bot -->
...
// $con=mysqli_connect("localhost","root","","thehomeplus");
								...
								$qs = mysqli_query($con,"SELECT * FROM `stock` where sid='$sid'");
...
<div class="banner-bootom-w3-agileits">
	<div class="container">
	     <div class="col-md-4 single-right-left ">
			<div class="grid images_3_of_2">
				<div class="flexslider">
					...
					<ul class="slides">
						<?php if ($rs['image']!="") { ?>			
						<li data-thumb="admin/prodimage/<?php echo $rs['image']; ?>">
							<div class="thumb-image"> <img src="admin/prodimage/<?php echo $rs['image']; ?>" height="200px" width="200px" data-imagezoom="true" class="img-responsive"> </div>
						</li>
						<?php	} ?>
						<?php if ($rs['image1']!="") { ?>	
						<li data-thumb="admin/prodimage/<?php echo $rs['image1']; ?>">
							<div class="thumb-image"> <img src="admin/prodimage/<?php echo $rs['image1']; ?>" height="200px" width="200px" data-imagezoom="true" class="img-responsive"> </div>
						</li>	
						<?php	} ?>
						<?php if ($rs['image2']!="") { ?>
						<li data-thumb="admin/prodimage/<?php echo $rs['image2']; ?>">
							<div class="thumb-image"> <img src="admin/prodimage/<?php echo $rs['image2']; ?>" height="200px" width="200px" data-imagezoom="true" class="img-responsive"> </div>
						</li>
						<?php	} ?>
		...
		<div class="col-md-8 single-right-left simpleCart_shelfItem">
					<h3><?php  echo $rp['pname']; ?></h3>
					<h5><?php  echo $rs['description']; ?></h5>
					<p><span class="item_price">₹​<?php  echo $rs['price'];  ?></span> <!-- <del>- $900</del> --></p>
				
					<div class="description">
						<h5>Check delivery, payment options and charges at your location</h5>
						 <form action="#" method="post">
						<input type="text" name="pincode" value="Enter pincode" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Enter pincode';}" required="">
						<input type="submit" name="pincheck" value="Check">
						</form>
					</div>
					<div class="color-quality">
						<div class="color-quality-right">
							<?php 		$qty1=0;
										if (isset($_SESSION['uid'])){
										$q7=mysqli_query($con,"SELECT * FROM `cart` WHERE userid='$_SESSION[uid]' and pid='$rs[sid]' and status='new' ");
										
										while($r7=mysqli_fetch_array($q7)){
										$qty1=$qty1+$r7['qty'];
										
										} }?>
							<h5>Available Quantity : <?php if (isset($_SESSION['uid']) && $rs['qty']!=0) { echo $rs['qty']-$qty1; } else { echo $rs['qty']; } ?></h5>
