...
$q=mysqli_query($con,"SELECT * FROM `service`"); ?>
		...
		<?php		while($r=mysqli_fetch_array($q)) {  ?>
						<tr>
                        <td><?php   echo $r['service_id']; ?>
                        <td><?php   echo $r['order_id']; ?>
                         <td><?php   echo $r['userid']; ?>
                        <td><?php   echo $r['product_id']; ?>
                        <td><img src="img/<?php echo $r['image']; ?>" height="100px" width="100px"> 
