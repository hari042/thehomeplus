...
$q=mysqli_query($con,"SELECT * FROM `stock`"); ?>
        ...
        <?php       while($r=mysqli_fetch_array($q)) {  ?>
                        <tr>
                            ...
                            <td><?php   echo $r['price']; ?></td>
                             <td><img height="50px" width="50px" src="prodimage/<?php   echo $r['image']; ?>"></td>
                            <td><?php   echo $r['description']; ?></td>
<td><button class="btn btn-warning"><a href="editstock.php?stid=<?php echo $r['sid']; ?>" style="color:#fff;">Update</a></button>|<button class="btn btn-danger"><a href="deletestock.php?stid=<?php echo $r['sid']; ?>" onclick=" return confirm('do you want to delete')" style="color:#fff;">Delete</a></button></td>
                        </tr>
