...
$q=mysqli_query($con,"SELECT * FROM `category`"); ?>
		...
		<?php		while($r=mysqli_fetch_array($q)) {  ?>
						<tr>
							...
							<td><img height="50px" width="50px" src="catimage/<?php   echo $r['image']; ?>"></td>
							<td><button class="btn btn-warning"><a href="editcat.php?catid=<?php echo $r['categoryid']; ?>" style="color:#fff;">Edit</a></button>|<button class="btn btn-danger"><a href="deletecat.php?catid=<?php echo $r['categoryid']; ?>" onclick=" return confirm('do you want to delete')" style="color:#fff;">Delete</a></button></td>
						</tr>
